...
$('#country').change(function(e) {
	var res = obj.dhx_ajax('sysManage_c/getOperatorBycountry/'+$(this).val() );
...
$('#addGateway').submit(function(e) {
    e.preventDefault();
	var res = obj.dhx_ajax('push_c/gateway/new',$(this).serialize() );
	if(res==='sucess'){
		obj.message_show('New Gateway has been added sucessfully');
		obj.grid['dhxDynFeild_t'].clearAndLoad('push_c/renderGateway');
		$(this)[0].reset();
	}
	else{

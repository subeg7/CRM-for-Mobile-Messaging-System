<form id="addMsgTemplate" action="#" name="unicode">
   ...
   <table id="senderType" class="displayOff">
        <tr >
        	<td><img style="height:17px;" src="images/load/DownRight.png"/><input class="sendertype" type="radio" name="sendertype" value="default"/> Default Sender ID</td>
    ...
    <table id="operType" class="displayOff">
        <tr >
        	<td><img style="height:17px;" src="images/load/DownRight.png"/>
			<?php
                if($operator!='none'){
    ...
    <table id="senderIDs"  class="displayOff">
         <tr>
            <td><img style="height:17px;" src="images/load/DownRight.png"/>Sender ID</td>
...
$('#addMsgTemplate').submit(function(e) {
	...
	console.log(arr);
	var res = obj.dhx_ajax('push_c/msgTemplate',arr.join('&') );
	if(res==='sucess'){
		obj.message_show('New Template has been added sucessfully');
		obj.grid['dhxDynFeild_t'].clearAndLoad('push_c/renderMsgTemplate');
		$(this)[0].reset();

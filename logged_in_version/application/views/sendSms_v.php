     ...
     <div id="normalSms">
     	<form id="normalSmsForm"  name="unicode">
            ...
            <div id="smsAddress" class="floatLeft">
            	<h3>Address Book & Cell Numbers<span class="allhelp"><span><p><span class="closeHelp">x</span>a browney fox quickly jumps over the lazy dog. a browney fox quickly jumps over the lazy dog.a browney fox quickly jumps over the lazy dog.</p></span><img src="images/load/allhelp.png"></span></h3>
                <div>
                	<div>
            ...
            <div id="smsMessage" class="floatLeft">
            	<h3>Messages<span class="allhelp"><span><p><span class="closeHelp">x</span>a browney fox quickly jumps over the lazy dog. a browney fox quickly jumps over the lazy dog.a browney fox quickly jumps over the lazy dog.</p></span><img src="images/load/allhelp.png"></span></h3>
            	<div>
                	<div>
...
<p>If you want to communicate with a large number of people at once but want to give specific information to specific people then EOM can help you. Individual get what is relevent to them. No need to mannually send single SMS to single number.
        ...
        <div id="eomInfo"  >
            ...
            <ul>
            	<li>With Header : this allows you to send seperate messages with heading <img src="images/load/with_header.JPG"/>
                </li>
            </ul>
        </div>
     </div>

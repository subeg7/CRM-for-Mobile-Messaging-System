...
var Ucr_dhx = function(){
		...
		this.g_imgP = 'vas/sms/images/load/imgs/'; // grid image path
		this.t_imgP = 'vas/sms/images/load/imgs/dhxtree_skyblue/'; // tree image path
		this.l_imgP = 'vas/sms/images/load/loading.gif'; // loading image path
	...
	Ucr_dhx.prototype.create_dhx_grid = function ( var_obj ){	
		...
		var tb_el = '<div id="'+tId+'" ></div><div id="'+pId+'" ><span id="'+paId+'"></span>&nbsp;<span id="'+iaId+'"></span></div>'+
					'<div id="'+olId+'" style="font-size:12px;">Please wait,&nbsp;<img style=" height:13px;" src="vas/sms/images/load/loading.gif"/></div>';		

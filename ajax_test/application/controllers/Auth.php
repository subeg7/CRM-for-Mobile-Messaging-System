...
class Auth extends CI_Controller {
	...
	function login()
	{
		...
		else
		{
			...
			$this->data['isLogin'] = FALSE;
			$this->data['hostName'] = explode('.',$_SERVER['HTTP_HOST']);
			$this->_render_page('auth/login', $this->data);//default
			// $this->_render_page('buttonDebug/main',null,null);//debug
			// $this->load->view('buttonDebug/mainfile');//debug
		}
	}

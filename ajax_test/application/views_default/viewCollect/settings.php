        ...
        <div>
            <table>
                ...
                <tr>
                    ...
                    <td><span class="edit" data-eval="<?php echo $data[0]->phone; ?>">[ Edit ]</span><span contenteditable="false" data-val="org_phone"><?php echo $data[0]->phone; ?></span></td>
                </tr>
                <tr>
                    <td>Contact Person :</td>
                    <td><span class="edit" data-eval="<?php echo strtolower($data[0]->contact_person); ?>">[ Edit ]</span><span contenteditable="false" data-val="contact_person"> <?php echo $data[0]->contact_person; ?></span></td>
                </tr>
                <tr>
                    <td>Contact Person Mobile No. :</td>
                    <td><span class="edit" data-eval="<?php echo strtolower($data[0]->contact_number); ?>">[ Edit ]</span><span contenteditable="false" data-val="contact_phone"><?php echo $data[0]->contact_number; ?></span></td>
                </tr>
                <tr>
                    <td>E-mail :</td>
                    <td><span class="edit" data-eval="<?php echo strtolower($data[0]->email); ?>">[ Edit ]</span><span contenteditable="false" data-val="email" style="text-transform:none;"><?php echo $data[0]->email; ?></span></td>
                </tr>
                <tr>
                    <td>Address :</td>
                    <td><span class="edit" data-eval="<?php echo strtolower($data[0]->address); ?>">[ Edit ]</span><span contenteditable="false" data-val="address"><?php echo $data[0]->address; ?></span></td>
                </tr>
            </table>
        </div>

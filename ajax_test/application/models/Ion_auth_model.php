...
class Ion_auth_model extends CI_Model
{
	...
	**/
	...
	public function login_remembered_user()
	{
		...
		// get the user
		$this->trigger_events('extra_where');
		$query = $this->db->select($this->identity_column.', id, email, fld_reseller_id,last_login')
		...
		if ($query->num_rows() == 1)
		{
			...
			$time = $this->update_last_login($user->id);

			$this->set_session($user,$time);

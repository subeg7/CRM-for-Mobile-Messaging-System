...
<div id="homeView">
	<h2><img src="assets/images/enterhome.png"/>Welcome </h2>
    <div id="homeLeft" class="floatLeft">
        <div id="homeBalance" class="homeDiv">
            <h3><img src="assets/images/homeBalance.png"/>Total Account balance till today </h3>
            <table>
            	<?php
				if($balance=='postpaid'){
        ...
        <div id="homeTransaction"  class="homeDiv">
            <h3><img src="assets/images/homeTransaction.png"/>Today's Total Transaction </h3>
            <table>
            	<?php
					if($transaction !='none'){
        ...
        <div id="homeTransaction"  class="homeDiv">
            <h3><img src="assets/images/homeInfo.png"/>Account Informations </h3>
            <table>
                <tr>
    ...
    <div id="homeRight" class="floatRight">
    	<h3><img src="assets/images/homeNotification.png"/>Quick Unseen Notification [ <span style="color:red;">within 7 days</span> ]</h3>
        <div id="homeNotification">
        	<ul>
            <?php
				if($notification!='none'){
					foreach($notification as $row){
						echo '<li data-id="'.$row->fld_int_id.'">'.$row->description.'<img src="assets/images/homeClose.png"/></li>';
					}
				}else{
...
$('#homeNotification ul li img').on('click',function(e){
	...
	// console.log("calling ajax");//debug
	var res = obj.dhx_ajax('common_c/noticeViewState/'+notiId );
	// console.log("call ended",res);//debug
	if(res=='sucess'){

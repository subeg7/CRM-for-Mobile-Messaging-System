<div id="assignShortcodeDetails">
	<div id="assignsDetails">
    	<p><input id="searchadd" placeholder="search addressbook" style="border:1px solid #a4bed4;width:200px; padding:3px; font-size:11px; margin-right:10px;"/><a href="#" onClick="return obj.treeSearch('assignDetailsTree');"><img src="vas/sms/images/load/searchadd.png" style="height:20px; vertical-align:bottom;"/></a></p>
...
obj.tree['assignDetailsTree'].attachEvent('onClick',function( id ){
			...
			var res = obj.dhx_ajax('vas/sms/pull_c/getUserKeys/'+selId+'/'+id );

		...
		$( "#mainLoadidng" ).animate({height: "100%"}, 300, function() {
			...
			$('#uploadInfo').animate({margin: "200px auto"}, 400,function(){
				if(typeof(Worker) !== "undefined") {
					...
					worker = new Worker("vas/sms/pull_c/pullView/uploadDb");
...
#uploadInfo p:nth-child(2){ height:40px; background: transparent url("vas/sms/images/load/loading.gif") no-repeat scroll 80px 0px / 20px 20px;background-position: center;

...
(function(){
	...
	obj.tree['addressbookTree'].attachEvent('onClick',function( id ){
		...
		var res = obj.dhx_ajax('vas/sms/pull_c/getPullReport/'+obj.comb['sortList'].getSelectedValue()+'/'+id+'/'+searchFrom+'/'+searchTill+'/'+parentNode);
	...
	obj.tree['addressbookTree'].load('vas/sms/pull_c/renderTreeList/'+obj.comb['sortList'].getSelectedValue()+'?object=tree',function(){
		setTimeout(function(){  $('#load').hide(); }, 500);

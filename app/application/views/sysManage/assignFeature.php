...
$('#featureFeild').on('click','div p:last-child',function(e) {
	...
	var res = obj.dhx_ajax('vas/sms/userManage_c/assignFeature/remove/'+id+'/'+selId );
	if(res==='sucess'){
		obj.winTooble = true;
...
$('#submit').click(function(e) {
	...
	var res = obj.dhx_ajax('vas/sms/userManage_c/assignFeature/assign/'+feaature+'/'+selId,param.join('&'));
	if(res==='sucess'){
		obj.winTooble = true;

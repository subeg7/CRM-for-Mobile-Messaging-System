...
<script language="javascript" type="text/javascript">
	...
	InitObj.prototype.addressBook = function (id){
		...
		ths.tree['addressbookTree'].load('vas/sms/push_c/renderAddressbook?object=tree',function(){
	...
	InitObj.prototype.uploadDb = function (id){
		...
		ths.tree['uploadkeyTree'].load('vas/sms/pull_c/renderKeyTree?object=tree',function(){
		...
		ths.tree['uploadkeyTree'].attachEvent('onClick',function( id ){
			if( id== 'keys') return;	
			ths.grid['uploadGrid_t'].clearAndLoad( "vas/sms/pull_c/renderUpload/"+id);
		});	
	}
	InitObj.prototype.scheduler = function (id){
		...
		this.create_dhx_grid({
			...
			enableEditEvents	: 'true,false,true',
			multi_select		: true,
			xml_link			: 'vas/sms/push_c/renderSchduler'
		 });
	}
	InitObj.prototype.MsgTemplate = function (id){
		...
		this.create_dhx_grid({
			...
			enableEditEvents	: 'true,false,true',
			multi_select		: true,
			xml_link			: 'vas/sms/push_c/renderTemplate'
		 });	
	}
	InitObj.prototype.userGrid = function (id,user){
		...
		this.create_dhx_grid({
			...
			enableEditEvents	: 'true,false,true',
			multi_select		: true,
			xml_link			: 'vas/sms/userManage_c/renderUser/'+( (this.ribb['ribbon'].getValue('combo_st')==1)?'approve':'suspend')
		 });
	...
	InitObj.prototype.queJob = function (id,user){
		...
		this.create_dhx_grid({
			...
			enableEditEvents	: 'true,false,true',
			multi_select		: true,
			xml_link			: 'vas/sms/push_c/renderQueue'
		 });
	}
	InitObj.prototype.gateway = function (id){
		...
		this.create_dhx_grid({
			...
			enableEditEvents	: 'true,false,true',
			multi_select		: true,
			xml_link			: 'vas/sms/push_c/renderGateway'
		 });
	}
	InitObj.prototype.senderid = function (id){
		...
		this.create_dhx_grid({
			...
			enableEditEvents	: 'true,false,true',
			multi_select		: true,
			xml_link			: 'vas/sms/push_c/renderSenderId'
		 });
	...
	InitObj.prototype.shortcode = function (id){
		...
		this.create_dhx_grid({
			...
			enableEditEvents	: 'true,false,true',
			multi_select		: true,
			xml_link			: 'vas/sms/pull_c/renderShortcode'
		 });
	}
	InitObj.prototype.category = function (id){
		...
		this.create_dhx_grid({
			...
			enableEditEvents	: 'true,false,true',
			multi_select		: true,
			xml_link			: 'vas/sms/pull_c/renderCategory'
		 });
	}
	InitObj.prototype.smsMsgTemplate = function (id){
		...
		this.create_dhx_grid({
			...
			enableEditEvents	: 'true,false,true',
			multi_select		: true,
			xml_link			: 'vas/sms/push_c/renderMsgTemplate'
		 });
	}
	InitObj.prototype.key = function (id){
		...
		this.create_dhx_grid({
			...
			enableEditEvents	: 'true,false,true',
			multi_select		: true,
			xml_link			: 'vas/sms/pull_c/renderKeys'
		 });
	...
	InitObj.prototype.group = function (id){
		...
		this.create_dhx_grid({
			...
			enableEditEvents	: 'true,false,true',
			multi_select		: true,
			xml_link			: 'vas/sms/sysManage_c/renderGroup'
		 });
	}
	InitObj.prototype.prefix = function (id){
		...
		this.create_dhx_grid({
			...
			enableEditEvents	: 'true,false,true',
			multi_select		: true,
			xml_link			: 'vas/sms/sysManage_c/renderPrefix'
		 });
	}
	InitObj.prototype.operator = function (id){
		...
		this.create_dhx_grid({
			...
			enableEditEvents	: 'true,false,true',
			multi_select		: true,
			xml_link			: 'vas/sms/sysManage_c/renderOperator'
		 });
	}
	InitObj.prototype.feature = function (id){
		...
		this.create_dhx_grid({
			...
			enableEditEvents	: 'true,false,true',
			multi_select		: true,
			xml_link			: 'vas/sms/sysManage_c/renderFeature'
		 });
	}
	InitObj.prototype.country = function (id){
		...
		this.create_dhx_grid({
			...
			enableEditEvents	: 'true,false,true',
			multi_select		: true,
			xml_link			: 'vas/sms/sysManage_c/renderCountry'
		 });
	}
	...
	InitObj.prototype.creditLog = function (id){
		...
		this.create_dhx_grid({
			...
			enableEditEvents	: 'true,false,true',
			multi_select		: true,
			//xml_link			: 'vas/sms/report_c/renderCredit'
		 });
	}
	...
	InitObj.prototype.dailyReport = function (id,priv){
		...
		this.create_dhx_grid({
			...
			enableEditEvents	: 'true,false,true',
			multi_select		: true,
			xml_link			:'vas/sms/report_c/renderTodayReport/dailyreport'
		 });
	}
	InitObj.prototype.detailLog = function (id){
		...
		this.create_dhx_grid({
			...
			enableEditEvents	: 'true,false,true',
			multi_select		: true,
			//xml_link			:'vas/sms/report_c/detailPull'
		 });
	}
	...
	InitObj.prototype.scheme = function (id,priv){
		...
		this.create_dhx_grid({
			...
			xml_link			: 'vas/sms/pull_c/renderScheme'
		 });
	...
	InitObj.prototype.deleteFun = function(res){
		...
		if(res===true){
			...
			if(obj.prev_id == 'country' || obj.prev_id == 'operator' || obj.prev_id == 'prefix' || obj.prev_id == 'group'|| obj.prev_id == 'feature'){
				res = obj.dhx_ajax('vas/sms/sysManage_c/deleteItem/'+obj.prev_id,'&id='+selId );
			}
			else if(obj.prev_id == 'shortcode' || obj.prev_id == 'category'){
				res = obj.dhx_ajax('vas/sms/pull_c/deleteItem/'+obj.prev_id,'&id='+selId );
			}
			else if(obj.prev_id == 'gateway'){
				res = obj.dhx_ajax('vas/sms/push_c/deleteItem/'+obj.prev_id,'&id='+selId );
			}
			else if(obj.prev_id == 'addressbook'){
				res = obj.dhx_ajax('vas/sms/push_c/deleteItem/'+obj.toolbar_id,'&id='+selId );
			}
			...
			if(res==='sucess'){
				...
				if(obj.toolbar_id =='address_delete'){
					...
					obj.grid['addressGrid_t'].clearAndLoad( "vas/sms/push_c/renderContact/"+obj.tree['addressbookTree'].getSelectedItemId() );
				}
				else if(obj.prev_id == 'scheme'){
	...
	InitObj.prototype.truncate = function(res){
		if(res===true){
			if(obj.prev_id == 'addressbook'){
				...
				res = obj.dhx_ajax('vas/sms/push_c/emptyContact/'+bookid);
				if(res=='sucess') obj.grid['addressGrid_t'].clearAndLoad( "vas/sms/push_c/renderContact/"+bookid );
			}
			else if(obj.prev_id == 'upload'){
				var upid = obj.tree['uploadkeyTree'].getSelectedItemId();
				res = obj.dhx_ajax('vas/sms/pull_c/truncateUpload/'+upid);
				if(res=='sucess') obj.grid['uploadGrid_t'].clearAndLoad( "vas/sms/pull_c/renderUpload/"+upid);
			}
	...
	InitObj.prototype.userManage = function(res){
		...
		if(res===true && obj.toolbar_id != null){
			var result = obj.dhx_ajax('vas/sms/userManage_c/manageUser/'+selId+'/'+ (( obj.toolbar_id =='usersuspend')?'suspend':'approve'));
			if(result=='sucess'){
...
<script type="text/javascript">
	...
	<?php require ('/var/www/easysms/app/assets/js/dhxRibbonEv.js'); ?>
	// this file contains all the events related to toolbar
	<?php require ('/var/www/easysms/app/assets/js/dhxToolbarEv.js'); ?>
</script>
